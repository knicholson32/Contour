/*
  ...
  - You are about to rename the column `forceUseBlock` on the `legs` table to `useBlock`.
...
INSERT INTO "new_legs" ("actualInstrument", "aircraftId", "checkride", "dayId", "dayLandings", "dayTakeOffs", "destinationAirportId", "distance", "diversionAirportId", "dualGiven", "dualReceived", "endTime_utc", "faa6158", "flightReview", "holds", "id", "ident", "ipc", "night", "nightLandings", "nightTakeOffs", "notes", "originAirportId", "passengers", "pic", "relativeOrder", "route", "sic", "sim", "simulatedInstrument", "solo", "startTime_utc", "totalTime", "useBlock", "xc") SELECT "actualInstrument", "aircraftId", "checkride", "dayId", "dayLandings", "dayTakeOffs", "destinationAirportId", "distance", "diversionAirportId", "dualGiven", "dualReceived", "endTime_utc", "faa6158", "flightReview", "holds", "id", "ident", "ipc", "night", "nightLandings", "nightTakeOffs", "notes", "originAirportId", "passengers", "pic", "relativeOrder", "route", "sic", "sim", "simulatedInstrument", "solo", "startTime_utc", "totalTime", "forceUseBlock", "xc" FROM "legs";
DROP TABLE "legs";
