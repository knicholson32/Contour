...
<li>
  <button {disabled} tabindex="-1" type="button" title="" on:click={focus} 
    class="touch-manipulation h-11 w-full px-3 py-1 bg-white dark:bg-zinc-900 text-gray-700 dark:text-gray-200 {disabled ? '' : 'betterhover:hover:bg-gray-50 betterhover:hover:text-black'} disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-400 inline-flex items-center justify-center gap-2 ring-0 focus-within:ring-0">
