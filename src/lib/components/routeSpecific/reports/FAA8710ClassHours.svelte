...
<div class="grid grid-cols-5 text-xs relative shadow-sm ring-1 ring-gray-900/5 dark:ring-zinc-700">
  ...
  <!-- R.C. -->
  <div class="row-span-1 border-b content-center text-center font-bold select-none bg-gray-100 dark:bg-zinc-925">
  ...
  <div class="bg-gray-100 dark:bg-zinc-925 -z-20 border-l border-b"></div>
  <div class="bg-gray-100 dark:bg-zinc-925 -z-20 border-l border-b"></div>
  <!-- L.T.A. -->
  ...
  <div class="bg-gray-50 dark:bg-zinc-900 -z-20 border-l border-b"></div>
  <div class="bg-gray-50 dark:bg-zinc-900 -z-20 border-l border-b"></div>
  <!-- Simulators -->
  <div class="row-span-3 content-center text-center font-bold select-none bg-gray-100 dark:bg-zinc-925">
  ...
  <div class="bg-gray-100 dark:bg-zinc-925 -z-20 border-l"></div>
</div>