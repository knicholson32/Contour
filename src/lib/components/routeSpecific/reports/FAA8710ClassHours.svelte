...
<div class="grid grid-cols-5 text-xs relative shadow-sm ring-1 ring-gray-900/5 dark:ring-zinc-700">
  ...
  <!-- R.C. -->
  <div class="row-span-1 border-b z-10 content-center text-center font-bold select-none bg-gray-100 dark:bg-zinc-925">
  ...
  {@render EmptyCell()}
  <!-- L.T.A. -->
  <div class="row-span-1 border-b z-10 content-center text-center font-bold select-none bg-gray-50 dark:bg-zinc-900">
  ...
  {@render EmptyCell(false)}
  {@render EmptyCell(false)}
  <!-- Simulators -->
  <div class="row-span-3 content-center z-10 text-center font-bold select-none bg-gray-100 dark:bg-zinc-925">
