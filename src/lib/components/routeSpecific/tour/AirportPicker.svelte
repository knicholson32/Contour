<script lang="ts">
  ...
  interface Props {
    value?: API.Types.Airport | null;
    tz?: string | null;
    airports: API.Types.Airport[];
    name: string;
    title: string;
    hoverTitle?: string;
    disabled?: boolean;
  ...
  let select: HTMLInputElement | null = $state(null);
...
<!-- TODO: This had to be removed with Svelte5 because nested forms are not allowed. Check that this works as intended. -->
