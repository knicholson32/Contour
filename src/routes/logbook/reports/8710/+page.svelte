...
<div class="m-6 flex flex-col lg:flex-row gap-6 print:hidden">
  <div class="grow flex flex-col gap-0 max-w-3xl">
    <div class="uppercase text-center text-base md:text-xs font-normal mb-1">Summary</div>
    <div class="grow flex flex-col divide-y gap-0 bg-gray-50 pb-[7px] dark:bg-zinc-900 shadow-xs ring-1 ring-gray-900/5 dark:ring-zinc-700">
      <div class="flex flex-row gap-6 mt-5 pb-5">
      ...
      <div class="grow flex flex-col gap-4 py-5">
      ...
      <div class="px-6 pb-4 pt-5 flex flex-col sm:flex-row w-full gap-4 sm:items-center justify-end">
  ...
  <div class="p-1 pb-6 print:p-1 w-full overflow-x-scroll touch-auto lg:overflow-x-hidden relative">
    <div class="grid grid-cols-13 min-w-[1000px] lg:min-w-full relative pr-6">
      ...
      <div class="print-color-adjust-exact col-span-12 col-start-2 row-span-8 grid grid-cols-12 grid-rows-subgrid text-xs text-center shadow-xs ring-1 ring-gray-900/5 dark:ring-zinc-700 relative">
        ...
        <FAA8710RowSim class="bg-zinc-100 dark:bg-zinc-925" data={data.ffs} even={true} title="FFS" />
        <FAA8710RowSim class="bg-zinc-50 dark:bg-zinc-900" data={data.ftd} even={false} title="FTD" />
        <FAA8710RowSim class="bg-zinc-100 dark:bg-zinc-925" data={data.atd} even={true} title="ATD" last={true} />
