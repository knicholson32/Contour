...
<TwoColumn menuZone="scroll" formZone="scroll" resizable={false} bind:urlActiveParam minSizes={{menu: 205, form: 475 }} defaultRatio={0.01} backText="Back">
