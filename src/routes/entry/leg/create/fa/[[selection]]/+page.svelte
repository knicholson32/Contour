...
<TwoColumn menu="scroll" form="scroll" backText="Back" bind:urlFormParam ratio={0.6} minSizes={{ menu: 650, form: 300 }} afterDrag={resetMap}>
    ...
    <form method="get">
      ...
      <Section title="Flight Aware Options" error={form !== null && form.ok === false && form.action === '?/default' && form.name === '*' ? form.message : null}>
        ...
        <Frame title="Options" required={false} name="" form={null} class="relative">
          <div slot="outsideButton" class="w-full overflow-x-auto whitespace-nowrap absolute top-0 bottom-0 right-0 left-0 pr-3">
