...
<TwoColumn left="safe" right="scroll" activeOnSingleCol="left">
  <ul slot="right" role="list" class="flex-shrink mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:max-w-none lg:grid-cols-3">
